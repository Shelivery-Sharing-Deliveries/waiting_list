  ...
  return (
    <section className="max-w-7xl mx-auto px-6 py-section-gap grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
      ...
      <div className="space-y-stack-md text-center lg:text-left">
        <div className="inline-flex items-center gap-2 px-3 py-1 bg-surface-container rounded-full text-primary font-label-bold text-micro-copy">
          <span className="w-2 h-2 rounded-full bg-primary animate-pulse"></span>
          Starting in Lausanne
        </div>
        <h1 className="font-headline-xl text-headline-xl text-on-background lg:text-5xl lg:leading-[1.1]">
        ...
        <div className="bg-white rounded-3xl p-6 border border-border-subtle ambient-shadow">
          ...
          <div className="mb-6 space-y-3">
            <div className="flex items-center gap-3 p-3 bg-surface-muted rounded-xl border border-border-subtle">
              ...
              <div className="flex-1 text-micro-copy text-text-muted truncate">ubereats.com/store/mcdonalds-lausanne...</div>
              <button className="bg-primary text-white px-4 py-1.5 rounded-lg text-micro-copy font-label-bold">Order</button>
            </div>
            <div className="flex items-center justify-between px-2">
              <div className="flex items-center gap-2">
                <span className="material-symbols-outlined text-secondary text-sm" data-icon="check_circle" data-weight="fill" style={{ fontVariationSettings: "'FILL' 1" }}>check_circle</span>
                <span className="text-micro-copy font-label-bold">Cart Imported</span>
              </div>
              <div className="text-micro-copy text-text-muted">Processing...</div>
            </div>
          </div>
          
          {/* Community Pool UI */}
          <div className="bg-accent-soft p-4 rounded-2xl mb-6">
            <div className="flex justify-between items-center mb-3">
              <div className="flex -space-x-2">
                ...
                <div className="w-8 h-8 rounded-full border-2 border-white bg-primary flex items-center justify-center text-[10px] text-white font-bold">YOU</div>
              </div>
              <span className="text-micro-copy font-label-bold text-primary">Pool progress: 3/3</span>
            </div>
          ...
          <div className="space-y-3 mb-6">
            <div className="flex gap-2">
              <div className="bg-surface-muted p-2 rounded-2xl rounded-tl-none max-w-[80%]">
                <p className="text-micro-copy">Order locked! We're saving $12 on delivery. 🚀</p>
              </div>
            </div>
            <div className="flex gap-2 justify-end">
              <div className="bg-primary text-white p-2 rounded-2xl rounded-tr-none max-w-[80%]">
